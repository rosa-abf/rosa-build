...
#    resources :repositories, :only => [:new, :create]
  ...
  # Commit Comments
  match '/projects/:project_id/git/commit/:commit_id/:id(.:format)', :controller => "comments", :action => :edit, :as => :edit_project_commit_comment, :via => :get
  match '/projects/:project_id/git/commit/:commit_id/:id(.:format)', :controller => "comments", :action => :update, :as => :project_commit_comment, :via => :put
  match '/projects/:project_id/git/commit/:commit_id/:id(.:format)', :controller => "comments", :action => :delete, :via => :delete
  # Blobs
