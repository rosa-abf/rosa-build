...
class ProductBuildList < ActiveRecord::Base
  ...
  state_machine :status, :initial => :build_pending do
    ...
    # :build_canceling => :build_completed - Worker hasn't time to cancel building because build had been already finished
    event :build_success do
      transition [:build_started, :build_canceling] => :build_completed
    end

    # :build_canceling => :build_failed - Worker hasn't time to cancel building because build had been already finished
